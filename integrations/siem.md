...
| Event | Description |
|---|---|
| `finding.created` | New security vulnerability discovered. [Severity](../reference/glossary.md#scoring-posture) varies by finding. |
| `finding.regressed` | Previously fixed finding has reappeared. Always high severity. |
| `finding.assigned` | [Finding](../reference/glossary.md#aisecops-operations) assigned to a team member for remediation. |
