...
When a security test identifies vulnerabilities, the findings need to be triaged, assigned, and resolved. [Finding](../reference/glossary.md#aisecops-operations) delegation tracks this workflow with clear ownership and status at every stage.
