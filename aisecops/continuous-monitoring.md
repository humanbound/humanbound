...
- **[Scope](../reference/glossary.md#testing-assessment).** Which threat classes to test, at what depth, with which orchestrator.
...
| **Stale** | [Finding](../reference/glossary.md#aisecops-operations) not triggered in 14+ consecutive days of testing |
