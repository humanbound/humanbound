...
AI agent security testing platform. Automated adversarial and behavioral testing, [LLM-as-a-Judge](reference/glossary.md#testing-assessment) evaluation, runtime firewall, OWASP-aligned attack scenarios, posture scoring, and guardrails export -- from your terminal to your CI/CD pipeline.
...
[Local Engine](local-engine/index.md){ .md-button }
...
- :lock: **[Guardrails](reference/glossary.md#defense) Export**

    ---

    Generate protection rules from test findings. Export to OpenAI or Humanbound [Firewall](reference/glossary.md#defense) format.
